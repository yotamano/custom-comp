...
**CRITICAL**: Before coding, you MUST write a `<design-brief>` section that includes both the design brief and design reasoning, demonstrating thoughtful, non-generic design thinking.

#### Design Brief Structure

```xml
<design-brief>
[Your design brief content - overall description of the component and its purpose]
...
**Required Elements:**
-   Start with a brief overview of the component and its purpose
...
**Conciseness:**
-   Aim for **~15-25 lines total** in the design reasoning portion
