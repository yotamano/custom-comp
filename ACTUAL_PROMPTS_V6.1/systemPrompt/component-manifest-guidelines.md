...
**CRITICAL:** The component manifest MUST match the component's implementation (React and CSS) in order for the component to be editable in consumption. If there is an inconsistency between the manifest and the implementation, this will result in poor editing experience in consumption.


## Configurability guidelines:

- **Inner Elements Structure**: Refer to <component-elements-guidelines /> for comprehensive guidance on when to create inner elements vs. using data & props, and how to structure your component hierarchy
