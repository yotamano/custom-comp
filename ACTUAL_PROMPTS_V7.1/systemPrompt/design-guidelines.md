...
2. "What would make a user say 'wow' when they see this?" → Aim for delight, not just function
3. "How can proportion and scale create visual interest?" → Vary sizes, use asymmetry intentionally
4. "What interaction details would make this feel polished?" → Hover states, transitions, micro-animations
...
*See <component-css-guidelines> for implementation patterns.*
---
...
-   **Accessibility**: All animations **MUST** respect the user's motion preferences. Use the `prefers-reduced-motion` media query to disable or reduce animations for users who need it. **Note**: This is the ONLY media query exception allowed in component CSS (see <component-css-guidelines>).
...
Users can resize component bounding boxes (300px-1200px). Your manifest and CSS must work together for the component to fill and adapt to any size.

### Manifest ↔ CSS Synchronization

**Manifest says**: Component can be resized
```json
{ "resizeDirection": "horizontalAndVertical" }
```

**CSS must**: Fill the bounding box
```css
.component {
...
**Result**: Fills any bounding box, adapts columns based on container width.