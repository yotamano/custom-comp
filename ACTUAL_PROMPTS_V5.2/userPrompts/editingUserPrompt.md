...
**For design-focused edits**: Before coding, you MUST write a `<design-reasoning>` section that demonstrates thoughtful, non-generic design thinking.
...
**Conciseness:**
-   Aim for **~10-15 lines total** in the design-reasoning section for edits
-   Be specific about what's changing and why
-   Focus on the delta, not re-documenting the entire component
-   For minor edits (text changes, small tweaks), skip the design-reasoning section entirely
